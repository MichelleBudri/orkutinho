...
// Menu
// ================================================================================================================
export function OrkutinhoMenu({ githubUser }) {
    ...
    <OrkutinhoMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        ...
        <nav>
          ...
          <div>
            <input placeholder="Pesquisar no Orkutinho" />
          </div>
        </nav>
      ...
      <OrkutinhoMenuProfileSidebar githubUser={githubUser} />
    </OrkutinhoMenu.Wrapper>
  )
}
OrkutinhoMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .OrkutinhoMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function OrkutinhoMenuProfileSidebar({ githubUser }) {
  return (
    <div className="OrkutinhoMenuProfileSidebar">
      <div>
...
// OrkutinhoProfileSidebarMenuDefault
// ================================================================================================================
export function OrkutinhoProfileSidebarMenuDefault() {
  return (
    <OrkutinhoProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
OrkutinhoProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
...
// Reset Styles
// ================================================================================================================
export const OrkutinhoStyles = css`
  *::-webkit-scrollbar {
    width: 8px;
  }
